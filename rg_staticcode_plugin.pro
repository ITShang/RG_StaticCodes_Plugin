DEFINES += RG_STATICCODE_PLUGIN_LIBRARY

# RG_StaticCode_Plugin files

SOURCES += rg_staticcode_pluginplugin.cpp \
    statisticalthread.cpp \
    statisticalfunction.cpp \
    parameter.cpp \
    codewidget.cpp

HEADERS += rg_staticcode_pluginplugin.h \
        rg_staticcode_plugin_global.h \
        rg_staticcode_pluginconstants.h \
    statisticalthread.h \
